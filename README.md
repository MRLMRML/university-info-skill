...
└── data/
    ├── universities.json       # ~100所高校多维度信息
    ├── disciplines.csv         # 学科评估 A 类数据
    └── config.yaml             # 高校名单与分类配置
```
...
| 211 高校名单（115所） | 教育部公开文件 | ✅ 权威 | 已定（不再新增） |
| 双一流名单（147所） | 教育部 2022 年第二轮评审 | ✅ 权威 | ~5年一轮 |
| 学科评估（A+/A/A-） | 教育部第四轮学科评估（2017） | ✅ 权威 | ~4-5年一轮 |
...
| 维度 | 数据量 |
|------|--------|
| 高校总数 | ~100 所（含全部 985 + 主要 211 + 新增双一流） |
| 学科评估记录 | ~230 条 A 类学科 |
| 含就业数据高校 | 20+ 所重点高校 |
| 含科研数据高校 | 15+ 所重点高校 |
| 简称映射 | 26 个 |
...
- ✅ 新增就业/科研/生源数据（20+ 所重点高校）
- ✅ 学科评估数据逐条对照教育部原始 PDF 校验
