...
合作联系：[realJerryKing@163.com](mailto:realJerryKing@163.com)

欢迎以下形式的合作：

- 📊 **数据共建** — 补充高校就业/科研/实验室/录取数据
- 🐛 **纠错反馈** — 发现数据有误？提 Issue 或 PR，附上来源链接
- 💡 **功能建议** — 有新查询场景或数据维度的想法？欢迎讨论
- 🌍 **国际化** — 帮助补充更多国家/地区的高校数据
- 🏫 **校企合作** — 高校/教育机构/招聘平台的数据合作
- 📝 **文档翻译** — 帮助翻译或优化多语言文档
